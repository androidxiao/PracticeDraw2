...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //这是与效果图相同的mode
        ComposeShader composeShader = new ComposeShader(bitmapShader1, bitmapShader2, PorterDuff.Mode.DST_ATOP);
        //下面查看各mode的样式
//        ComposeShader composeShader = new ComposeShader(bitmapShader1, bitmapShader2, PorterDuff.Mode.SRC_ATOP);
